...
import (
	...
	limited_support "github.com/openshift/osd-metrics-exporter/pkg/controller/limited-support"
...
func init() {
	...
	AddToManagerFuncs = append(AddToManagerFuncs, oauth.Add, clusterrole.Add, group.Add, proxy.Add, configmap.Add, limited_support.Add)
}
