...
replace (
	...
	k8s.io/api => github.com/openshift/kubernetes/staging/src/k8s.io/api v0.0.0-20260827210922-fb553cd10595
	k8s.io/apiextensions-apiserver => github.com/openshift/kubernetes/staging/src/k8s.io/apiextensions-apiserver v0.0.0-20260827210922-fb553cd10595
	k8s.io/apimachinery => github.com/openshift/kubernetes/staging/src/k8s.io/apimachinery v0.0.0-20260827210922-fb553cd10595
	k8s.io/apiserver => github.com/openshift/kubernetes/staging/src/k8s.io/apiserver v0.0.0-20260827210922-fb553cd10595
	k8s.io/client-go => github.com/openshift/kubernetes/staging/src/k8s.io/client-go v0.0.0-20260827210922-fb553cd10595
)
