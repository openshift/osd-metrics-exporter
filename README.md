...
Note that the tests expect the cluster ID to be assigned to an environment variable called `OCM_CLUSTER_ID`, and the suite will quickly fail if this is unset.
