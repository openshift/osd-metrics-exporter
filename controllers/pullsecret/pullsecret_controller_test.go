...
pull_secret_valid{_id="test-cluster-id",name="osd_exporter",reason="Valid"} 1
`,
		},
		{
...
# HELP pull_secret_valid Indicates if the cluster pull secret is valid (1=valid, 0=invalid)
# TYPE pull_secret_valid gauge
pull_secret_valid{_id="test-cluster-id",name="osd_exporter",reason="MissingRegistry"} 0
`,
		},
		{
...
# HELP pull_secret_valid Indicates if the cluster pull secret is valid (1=valid, 0=invalid)
# TYPE pull_secret_valid gauge
pull_secret_valid{_id="test-cluster-id",name="osd_exporter",reason="EmptyCredential"} 0
`,
		},
		{
...
# HELP pull_secret_valid Indicates if the cluster pull secret is valid (1=valid, 0=invalid)
# TYPE pull_secret_valid gauge
pull_secret_valid{_id="test-cluster-id",name="osd_exporter",reason="EmptyAuths"} 0
`,
		},
		{
			name:   "malformed JSON",
...
# HELP pull_secret_valid Indicates if the cluster pull secret is valid (1=valid, 0=invalid)
# TYPE pull_secret_valid gauge
pull_secret_valid{_id="test-cluster-id",name="osd_exporter",reason="MalformedJSON"} 0
`,
		},
		{
...
# HELP pull_secret_valid Indicates if the cluster pull secret is valid (1=valid, 0=invalid)
# TYPE pull_secret_valid gauge
pull_secret_valid{_id="test-cluster-id",name="osd_exporter",reason="MissingKey"} 0
`,
		},
	} {
...
# HELP pull_secret_valid Indicates if the cluster pull secret is valid (1=valid, 0=invalid)
# TYPE pull_secret_valid gauge
pull_secret_valid{_id="test-cluster-id",name="osd_exporter",reason="SecretNotFound"} 0
`
	metric := metricsAggregator.GetPullSecretValidMetric()
...
func TestValidatePullSecret(t *testing.T) {
	for _, tc := range []struct {
		...
		},
		{
			...
			expectValid:    false,
			expectedReason: ReasonMissingKey,
		},
		{
			name:           "invalid JSON",
			secret:         makeTestPullSecret([]byte(`not json`)),
			expectValid:    false,
			expectedReason: ReasonMalformedJSON,
		},
		{
			name:           "empty auths",
			secret:         makeTestPullSecret([]byte(`{"auths":{}}`)),
			expectValid:    false,
			expectedReason: ReasonEmptyAuths,
		},
		{
			...
			expectValid:    false,
			expectedReason: ReasonMissingRegistry,
		},
		{
			...
			expectValid:    false,
			expectedReason: ReasonEmptyCredential,
		},
	} {
		t.Run(tc.name, func(t *testing.T) {
